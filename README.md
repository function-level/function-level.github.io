...
**Function-level Algebra:** With the abandonment of lambda variables, an algebra and its rules emerge (if not? --> tell us [Issues](https://github.com/function-level/function-level.github.io/issues))
